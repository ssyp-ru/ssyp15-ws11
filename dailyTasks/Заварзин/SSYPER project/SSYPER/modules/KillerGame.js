...
var KillerGame=function()
{
    ...
    this.GetTargetIdEveryone=function()
    {
    ...
    {
        //var preycir=this.KillerPlayers.length;
        var pickable=0;
    ...
    {
        //console.log(firstid,GetIndexById(firstid,this.KillerPlayers))
    ...
    this.CheckStartable=function()
    {
        ...
        if(this.CheckContinuable()==true)
        {
            ...
            //this.KillerPlayers[0].Alive=false;
            this.GetTargetIdEveryone();
            //console.log("Uchastniki:",this.KillerPlayers);
            //this.Killing(this.KillerPlayers[0],this.KillerPlayers[1]);
        }
    }
}
