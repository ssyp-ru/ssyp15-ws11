...
QuestBase.push(new Quest("hochet pley Fatball",[],0,"g","o",[10],["PLEID FATBAL AND BREK NOGA!"],[[QuestBase[GetIndexByName("must go to de doc",QuestBase)]]],20));
...
//QuestBase.push(new Quest("nashel beigik",[],0,"e","o",[0],["popitals9 pochest imya"],[["chei-to bagik"]],2));
