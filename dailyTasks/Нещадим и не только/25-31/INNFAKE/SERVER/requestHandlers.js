...
res.end(date.getFullDate());
}
function Avtors(res) {
    reader.sendFileSave("./avtors.html", res);
}
function Top(res) {
    reader.sendFileSave("./toptop.html", res);
}
function TopP(res,param) {
    res.end(TOP.Top(walkers.walkers,param["sort"]));
}
exports.Top=Top;
exports.TopP=TopP;
exports.Avtors=Avtors;
exports.getNF=getNF;
exports.get=get;
exports.login=login;
exports.start = start;
