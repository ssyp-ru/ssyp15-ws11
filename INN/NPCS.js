...
//Татьяна Ивановна
var TI = new Npc("black", "Татьяна Ивановна", "f", 666, 100, 1000, "all", ["Иди оденься по погоде", "Иди помойся,маня"], function (pers) {
...
var Dultsev = new Npc("#C40000", "Дульцев", "m", 777, 100, -1000, ["workshops", "canteen", "mainHouse", "square"], ["Сходи в душ"], function (pers) {
    pers.say("Д У Л Ь Ц Е В B O Y S");
...
var IV = new Npc("orange", "Ирина Викторовна", "f", 905, 100, 0, "all", ["Отнеси стулья из мастерской в столовую"], function (pers) {
...
var TN = new Npc("pink", "Татьяна Николаевна", "f", 906, 100, 0, "all", ["Оденься по погоде", "Отправляйся в мед. пункт"], function (pers) {
...
var bear = new Npc("brown", "Медведь", "m", 907, 100, 500, "all", ["Беги в корпус"], function (pers) {
    bear.speed = 8;
