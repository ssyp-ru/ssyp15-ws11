...
QuestBase.push(new Quest ("dolzhen uspet na zaryadku",[new Time (-1,8,30),"gender=m"],20,"gf","r",[10],["nastroenie v poryadke-spasibo zaryadke!","vi otzimaetes"],[[],[QuestBase[GetIndexByName("otzhimaetsya",QuestBase)]]],15));
QuestBase.push(new Quest ("idet k masteram uznat o smisle zhizni",0,0,"g","o",[4],["poznaet istinnuy sut of professional programin"],[[0],[0]],30));
QuestBase.push(new Quest ("idet vtrechyat roditelei",0,0,"g","o",[2],["vstrechaet roditelei,poluchaet book of professional programin and a lot of money"],[[300,"book"],[0]],15));
